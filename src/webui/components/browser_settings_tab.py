...
async def close_browser(armogpt_manager: ArmoGPTManager):
    """
    Close browser
    """
    if armogpt_manager.bu_current_task and not armogpt_manager.bu_current_task.done():
        armogpt_manager.bu_current_task.cancel()
...
def create_browser_settings_tab(armogpt_manager: ArmoGPTManager):
    """
    ...
    armogpt_manager.add_components("browser_settings", tab_components)

    async def close_wrapper():
        """Wrapper for handle_clear."""
        await close_browser(armogpt_manager)
