...
async def update_mcp_server(mcp_file: str, armogpt_manager: ArmoGPTManager):
    ...
    """
    if hasattr(armogpt_manager, "bu_controller") and armogpt_manager.bu_controller:
...
def create_agent_settings_tab(armogpt_manager: ArmoGPTManager):
    """
    ...
    armogpt_manager.add_components("agent_settings", tab_components)
